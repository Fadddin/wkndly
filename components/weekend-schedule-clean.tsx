...
export function WeekendSchedule() {
  ...
  const { scheduledActivities, selectedActivities, draggedActivity, dragOverSlot, longWeekendOption, activityVibes } = state
  ...
  const timeSlots = getTimeSlots(longWeekendOption)
  ...
  const renderDayCard = (day: typeof weekendDays[0]) => (
